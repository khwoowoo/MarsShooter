...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="images/mark.png">
    <title>Shooting</title>
    <style>
    @font-face{
    font-family: "CookieRunFont_OTF/CookieRun Bold.otf";
